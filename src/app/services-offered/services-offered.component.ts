...
export class ServicesOfferedComponent implements OnInit {
  services = [
    ...
    { photo: 'url(/assets/tarifs/osteo.jpeg)', 
      title: 'Ostéopathie',
      desc: "Grâce à une palpation fine et précise, une évaluation complète et globale permet d’investiguer \
      la cause des dysfonctions neuro-musculo-squelettiques, viscérales et crâniennes. Chaque traitement \
      ostéopathique est spécifique et individualisé.",
      source: "https://www.osteopathiequebec.ca/fr/quest-ce-que-losteopathie"
    },
  ];
  constructor() { }
